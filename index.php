...
<html lang="en">
  ...
  <header role="banner" class="probootstrap-header">
    <div class="container">
        <a href="index.html" class="probootstrap-logo">Unipare<span>.</span></a>
  ...
  <section class="probootstrap-slider flexslider">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <div class="probootstrap-slider-text text-center text-dark">
              <h1 class="probootstrap-heading probootstrap-animate mb20" data-animate-effect="fadeIn">UNIPAIR</h1>
              <div class="probootstrap-animate probootstrap-sub-wrap mb30" data-animate-effect="fadeIn"> Show the best comparison </div>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- slider image -->
    <ul class="slides">
      <li style="background-image: url(img/pic1.PNG);"></li>
      <li style="background-image: url(img/pic2.PNG);"></li>
    </ul>
  </section>
  <!-- END: slider  -->
                        ...
                        if($count != 3) {
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 probootstrap-animate"
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="text">
                                    <h2 class="heading"><?php echo $result['unvname']; ?></h2>
                                        <h2 class="heading">
                                            <?php
                                            $str = $result['details'];
                                            $snip = substr($str, 0,50);
                                            echo $snip;
                                            ?>
                                        </h2>
